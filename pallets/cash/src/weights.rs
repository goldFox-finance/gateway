...
impl WeightInfo for () {
    ...
    fn set_yield_next() -> Weight {
        (172_000_000 as Weight)// This file is part of Substrate.
        ...
        //!
        //! THIS FILE WAS AUTO-GENERATED USING THE SUBSTRATE BENCHMARK CLI VERSION 2.0.0
        //! DATE: 2021-04-08, STEPS: [], REPEAT: 10, LOW RANGE: [], HIGH RANGE: []
        //! EXECUTION: Some(Wasm), WASM-EXECUTION: Compiled, CHAIN: None, DB CACHE: 128
        ...
        impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
            fn publish_signature() -> Weight {
                (399_906_000 as Weight)
                    .saturating_add(T::DbWeight::get().reads(5 as Weight))
                    .saturating_add(T::DbWeight::get().writes(1 as Weight))
            }
            fn set_yield_next() -> Weight {
                (243_228_000 as Weight)
                    .saturating_add(T::DbWeight::get().reads(5 as Weight))
                    .saturating_add(T::DbWeight::get().writes(5 as Weight))
            }
            fn receive_event() -> Weight {
                (384_011_000 as Weight)
                    .saturating_add(T::DbWeight::get().reads(4 as Weight))
                    .saturating_add(T::DbWeight::get().writes(1 as Weight))
            }
        }
